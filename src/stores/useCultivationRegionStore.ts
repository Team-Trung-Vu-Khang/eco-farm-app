...
const MOCK_DATA: CultivationRegion[] = [
  {
    name: "Vùng canh tác dừa công nghệ cao 3",
    scope: "area",
    targetIds: ["sub-1-1", "sub-1-2", "5"],
    targetName:
      "Khu A - Dừa xiêm xanh, Khu B - Dừa dứa, Khu Phức hợp Nông nghiệp Công nghệ cao",
    enterpriseId: "1",
  ...
  {
    name: "Vùng canh tác dừa công nghệ cao 2",
    scope: "region",
    targetIds: ["1", "3"],
    targetName: "Vùng Dừa Bến Tre Alpha, Vùng Dừa Công nghiệp Tiền Giang",
    enterpriseId: "1",
  ...
  {
    id: "ca-1",
    name: "Canh tác Dừa Công nghệ cao",
    scope: "region",
    targetIds: ["1"],
    ...
    enterpriseId: "DN001",
    managerIds: ["1"],
    note: "Dự án thử nghiệm canh tác dừa công nghệ 4.0",
  ...
  {
    id: "ca-2",
    name: "Khu vực trồng Dừa xiêm xanh Xuất khẩu",
    scope: "area",
    targetIds: ["sub-1-2"],
    targetName: "Khu vực B - Vườn dừa ven kênh",
    certificateIds: ["Organic"],
    enterpriseId: "DN001",
    managerIds: ["2"],
    note: "Canh tác dừa theo tiêu chuẩn hữu cơ EU",
    farmingMethodId: "organic",
  ...
  {
    id: "ca-3",
    name: "Lô trồng Dừa chất lượng cao",
    scope: "plot",
    targetIds: ["plot-1-1-1"],
    targetName: "Lô A1 - Vườn dừa mẫu lớn",
    certificateIds: ["GlobalGAP"],
    enterpriseId: "DN002",
    managerIds: ["3"],
    note: "Mô hình dừa hữu cơ kết hợp nuôi thủy sản",
  ...
  },
  {
    ...
    enterpriseId: "DN003",
    managerIds: ["1"],
    note: "Khu vực nhân giống dừa và bảo tồn nguồn gen",
    farmingMethodId: "greenhouse",
