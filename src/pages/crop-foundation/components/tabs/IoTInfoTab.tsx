...
export function IoTInfoTab({ cropFoundation }: IoTInfoTabProps) {
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-2 duration-500">
      <div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {cropFoundation.iotData?.current.map((metric, idx) => (
            <Card
              key={idx}
          ...
          {[
            {
              ...
              data: cropFoundation.iotData?.history3Days,
            },
            {
              label: "Cách đây 1 tuần",
              data: cropFoundation.iotData?.history1Week,
            },
            {
              label: "Cách đây 1 tháng",
              data: cropFoundation.iotData?.history1Month,
            },
          ].map((comparative, idx) => (
            <Card
              key={idx}
