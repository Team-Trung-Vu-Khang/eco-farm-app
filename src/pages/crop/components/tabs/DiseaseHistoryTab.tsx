...
export function DiseaseHistoryTab({ crop }: DiseaseHistoryTabProps) {
  const history = crop.diseaseHistory ?? [];
              ...
              <div className="flex items-center gap-6">
                <div className="text-right">
                  ...
                  <p className="text-sm font-bold text-slate-900">
                    {disease.treatmentTime || EMPTY_TEXT}
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                <div className="space-y-6">
                  ...
                  <div className="relative pl-8 space-y-8 before:absolute before:left-[11px] before:top-2 before:bottom-2 before:w-0.5 before:bg-slate-100">
                    {disease.treatmentProcess.length === 0 && (
                ...
                <div className="space-y-8">
                  <div>
                    ...
                    <div className="p-4 bg-amber-50/50 rounded-xl border border-amber-100/50 italic text-slate-600 text-sm font-medium">
                      {disease.note ? `"${disease.note}"` : EMPTY_TEXT}
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      {disease.materialsUsed.length === 0 && (
                        <p className="text-sm text-slate-400">{EMPTY_TEXT}</p>
                      )}
