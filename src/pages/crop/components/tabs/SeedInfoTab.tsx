...
export function SeedInfoTab({ crop }: SeedInfoTabProps) {
  const contractId = crop.seedInfo?.contractId;
  const importDate = crop.seedInfo?.importDate;
  const documents = crop.seedInfo?.documents ?? [];
            ...
            <div className="space-y-6">
              <div className="group">
                ...
                <p className="text-base font-bold text-slate-700 bg-slate-50/50 p-3 rounded-xl border border-slate-100/80">
                  {crop.seedInfo?.supplier || "Chưa có thông tin"}
                </p>
              </div>
              {contractId && (
                <div className="group">
              ...
              <div className="space-y-6">
                <div className="group">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-bold text-slate-800">{importDate}</p>
