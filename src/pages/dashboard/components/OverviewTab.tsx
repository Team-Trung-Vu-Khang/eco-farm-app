        ...
        {loading ? (
          <div className="h-[250px] flex items-center justify-center animate-pulse bg-slate-50 rounded-lg">
            <span className="text-xs text-muted-foreground">
              Đang tải dữ liệu tiêu thụ vật tư...
            </span>
          </div>
        ) : viewType === "chart" ? (
          <div className="h-[300px]">
            {data.length === 0 ? (
              <div className="h-full flex items-center justify-center">
                <p className="text-xs text-muted-foreground">
                  Chưa có thông tin tiêu thụ cho bộ lọc này.
                </p>
              </div>
            ) : (
                  ...
                  data.map((row) => (
                    ...
                    >
                      ...
                      <TableCell className="text-right font-mono">
                        {formatNumber(row.pesticide)}
                      </TableCell>
                      <TableCell className="text-right font-mono">
                        {formatNumber(row.fertilizer)}
                      </TableCell>
                      <TableCell className="text-right font-mono">
                        {formatNumber(row.machinery)}
                      </TableCell>
                      <TableCell className="text-right font-mono">
              ...
              <Tooltip>
                ...
                <TooltipContent>
                  <p className="max-w-xs text-xs">
                    Căn cứ theo kế hoạch trước đó, hoặc tổng công việc phát sinh
                    không quá 10 ngày
                  </p>
                </TooltipContent>
              </Tooltip>
