...
import { MOCK_SEEDS, type DistributionMethod, type PlantEntry, type RowConfig } from "../constants";
...
type Props = {
  ...
  onChangeMethod: (method: DistributionMethod) => void;
  ...
  onRemovePlantEntry: (id: string) => void;
  onAddRowConfig: () => void;
  onUpdateRowConfig: (
    id: string,
...
export const PlantDistributionConfigurationStep = ({
  selectedSeedIds,
  distributionMethod,
  plantEntries,
  rowConfigs,
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {[
                    ...
                    return (
                      <div
                        key={method.id}
                        onClick={() => onChangeMethod(method.id as DistributionMethod)}
                ...
                <CardHeader className="border-b bg-slate-50/50 pb-4">
                  <div className="flex items-center justify-between">
                    ...
                    >
                      ...
                      {distributionMethod === "zone" ? "Thêm loại cây" : "Thêm hàng mới"}
                    </Button>
                  </div>
                </CardHeader>
                          ...
                          >
                            ...
                            <div className="col-span-5 sm:col-span-4">
                              ...
                              <Select
                                value={entry.variety}
                                onValueChange={(value) =>
                                  onUpdatePlantEntry(entry.id, "variety", value)
                                }
                              >
                            ...
                            <div className="col-span-4 sm:col-span-5">
                              ...
                              <Select
                                value={entry.seedId}
                                onValueChange={(value) =>
                                  onUpdatePlantEntry(entry.id, "seedId", value)
                                }
                                disabled={!entry.variety}
                              >
                                <SelectTrigger className="h-9 bg-slate-50 border-slate-200 focus:bg-white focus:ring-primary/20">
                                  <SelectValue
                                    placeholder={entry.variety ? "Chọn hạt..." : "---"}
                                  />
                                </SelectTrigger>
                                <SelectContent>
                                  {selectedSeeds
                                    .filter((seed) => seed.variety === entry.variety)
                                    .map((seed) => (
                            ...
                            <div className="col-span-12 sm:col-span-1 flex items-end justify-end sm:justify-center">
                              <Button
                                variant="ghost"
                                size="icon"
                                onClick={() => onRemovePlantEntry(entry.id)}
                          ...
                          >
                            ...
                            <div className="col-span-8 sm:col-span-4">
                              ...
                              >
                                ...
                                <SelectContent>
                                  {selectedSeeds
                                    .filter((seed) => seed.variety === row.variety)
                                    .map((seed) => (
                                      <SelectItem key={seed.id} value={seed.id}>
                                        {seed.name}
                                      </SelectItem>
