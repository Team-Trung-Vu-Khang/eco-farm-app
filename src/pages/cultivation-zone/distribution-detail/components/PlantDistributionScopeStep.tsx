...
import type { DistributionScope } from "../constants";
import {
  MOCK_AREAS,
  MOCK_PLOTS,
  MOCK_REGIONS,
...
type Props = {
  ...
  onChangeScope: (scope: DistributionScope) => void;
  onSelectRegion: (id: string) => void;
  onToggleArea: (id: string) => void;
  onTogglePlot: (id: string) => void;
};

export const PlantDistributionScopeStep = ({
  scope,
  selectedRegionId,
  selectedAreaIds,
  selectedPlotIds,
      ...
      <div className="space-y-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {[
            ...
            <div
              key={item.id}
              onClick={() => onChangeScope(item.id as DistributionScope)}
