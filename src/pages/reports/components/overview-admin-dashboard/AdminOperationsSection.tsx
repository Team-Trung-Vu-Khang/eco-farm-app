...
import { FileText, Clock, PlayCircle, Briefcase } from "lucide-react";
...
export const AdminOperationsSection: React.FC<AdminOperationsSectionProps> = ({ selectedEntity }) => {
    ...
    <div className="space-y-4">
      <div>
        ...
        <p className="text-[11px] text-slate-400 font-medium mt-0.5">
          Theo dõi tiến độ kế hoạch canh tác và công việc chi tiết của nhân sự theo đơn vị
        </p>
      </div>
