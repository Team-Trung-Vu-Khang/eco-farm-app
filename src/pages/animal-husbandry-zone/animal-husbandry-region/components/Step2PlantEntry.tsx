          ...
          <div className="flex items-start gap-4 flex-1 min-w-0">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-sm text-blue-700/80">
                Mỗi cá thể có thể thuộc một lô/vị trí khác nhau trong vùng chăn
                nuôi.
              </p>
            </div>
          </div>
            ...
            <div className="text-sm space-y-0.5">
              <div>
                <span className="font-bold">
                  {unplaced.length === 1
                    ? "1 cá thể chưa được chọn chuồng/lô."
                    : `${unplaced.length} cá thể chưa được chọn chuồng/lô.`}
                </span>{" "}
                Vui lòng chọn Chuồng/Lô cho các cá thể dưới đây.
              </div>
            </div>
          </div>
        );
