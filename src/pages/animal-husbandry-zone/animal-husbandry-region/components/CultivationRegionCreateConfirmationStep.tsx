...
export const CultivationRegionCreateConfirmationStep = ({
  ...
  description = "Vui lòng kiểm tra kỹ các thông tin dưới đây. Sau khi xác nhận, hệ thống sẽ tiến hành khởi tạo vùng chăn nuôi mới.",
}: Props) => {
  return (
          ...
          <div className="p-6 space-y-6">
            ...
            <div className="pt-4 border-t border-slate-100">
              <div className="text-xs text-muted-foreground uppercase tracking-wider font-bold mb-3 flex items-center gap-2">
                <PawPrint className="w-4 h-4 text-amber-600" />
                Vật nuôi &amp; Giống ({cropSummary.length} vật nuôi)
              </div>
              ...
              {cropSummary.length === 0 ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {cropSummary.map((crop) => (
                    ...
                    >
                      {/* Crop/Animal header */}
                      <div className="flex items-center gap-2 px-4 py-3 bg-amber-50/60 border-b border-slate-100">
