...
const getScopeLabel = (scope: string) => {
  if (scope === "region") return "Vùng chăn nuôi";
      ...
      <Card>
        ...
        <CardContent className="pt-6 space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              <div className="text-sm text-muted-foreground">DT chăn nuôi</div>
              <div className="font-medium mt-1 text-lg text-green-600">
                {(details.totalArea * 0.9).toFixed(1)} ha
              </div>
            </div>
            <div>
              <div className="text-sm text-muted-foreground">Vật nuôi chính</div>
              <div className="font-medium mt-1 text-slate-900">
                {primaryCrops || "Chưa xác định"}
              </div>
            </div>
            <div>
              <div className="text-sm text-muted-foreground">Hình thức chuồng</div>
              <div className="font-medium mt-1 text-slate-900">Chuồng sàn khép kín</div>
            </div>
            <div>
              <div className="text-sm text-muted-foreground">Hệ thống chăn nuôi</div>
              <div className="font-medium mt-1 text-slate-900">
