              ...
              <CardContent className="pt-6 space-y-5">
                <div className="space-y-2">
                  <Label className="text-sm font-medium">
                    Loại hình chăn nuôi <span className="text-red-500">*</span>
                  </Label>
                  <Select
                  ...
                  >
                    <SelectTrigger className="h-11 bg-white">
                      <SelectValue placeholder="Chọn phương pháp chăn nuôi..." />
                    </SelectTrigger>
                    <SelectContent>
                  ...
                  <p className="text-xs text-muted-foreground">
                    Quyết định danh sách con giống phù hợp
                  </p>
                </div>

                <div className="space-y-2">
                  <Label className="text-sm font-medium">
                    Hệ thống cấp nước/chuồng trại <span className="text-red-500">*</span>
                  </Label>
                  <Select
                  ...
                  <DialogContent className="sm:max-w-md">
                    ...
                    <div className="py-4">
                      <p className="text-sm text-slate-600 leading-relaxed">
                        Bạn có chắc chắn muốn áp dụng phương pháp chăn nuôi, hệ
                        thống cấp nước/chuồng trại và danh sách vật nuôi hiện tại cho{" "}
                              ...
                              >
                                ...
                                <div className="flex flex-col flex-1 shrink min-w-0">
                                  ...
                                  {commonConfig.seedSelections?.[crop.id] &&
                                    commonConfig.seedSelections[crop.id].length >
                                      0 && (
                                      <div className="mt-1.5 flex flex-wrap gap-1.5 min-w-0">
                                        {commonConfig.seedSelections[crop.id].map(
                                          (seedId) => {
