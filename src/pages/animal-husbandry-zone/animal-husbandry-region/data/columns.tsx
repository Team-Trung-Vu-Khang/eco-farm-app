...
const SCOPE_TYPE_LABELS: Record<string, string> = {
  REGION: "Vùng chăn nuôi",
  AREA: "Khu vực",
  PLOT: "Trang trại",
};

const STATUS_LABELS: Record<string, string> = {
  active: "Đang chăn nuôi",
  inactive: "Ngừng chăn nuôi",
  archived: "Lưu trữ",
};

export const getAnimalHusbandryRegionColumns =
  (): Column<FarmCultivationZoneResponse>[] => [
    {
      key: "code",
      label: "Mã",
      render: (_, row) => (
        <Link href={`/animal-husbandry-region/${row.id}`}>
