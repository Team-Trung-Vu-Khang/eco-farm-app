...
const formSchema = z.object({
  code: z.string().min(1, { message: "Mã thông số là bắt buộc" }),
  name: z.string().min(1, { message: "Tên thông số là bắt buộc" }),
...
interface LandSpecsFormDialogProps {
  ...
  isEdit: boolean;
  initialData: LandSpecsFormData;
  onSubmit: (data: LandSpecsFormData) => void;
...
export function LandSpecsFormDialog({
  ...
  return (
    <FormDialog
      ...
      title={
        isEdit ? "Chỉnh sửa thông số địa hình" : "Thêm thông số địa hình mới"
      }
