...
import SimpleMaterialForm from "./components/SimpleMaterialForm";
...
const MaterialCreatePage = () => {
  ...
  if (loading) {
    return (
      <PageWrapper title={isEdit ? "Cập nhật vật tư" : "Thêm mới vật tư"}>
    ...
    >
      ...
      <div className="mb-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2.5 bg-white/80 backdrop-blur-sm border border-slate-200 rounded-full px-3 py-1.5 shadow-sm">
          <Label htmlFor="material-detail-mode" className="text-xs font-semibold text-slate-600 cursor-pointer select-none">
            Thông tin chuyên sâu
          </Label>
          <Switch
            id="material-detail-mode"
