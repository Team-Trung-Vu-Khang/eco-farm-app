...
import type { Branch, CooperativeFormData } from "../../types/types";

interface BranchesStepProps {
  formData: CooperativeFormData;
  newBranch: Branch;
  setNewBranch: (branch: Branch) => void;
  branchInputMethod: "create" | "excel";
  setBranchInputMethod: (method: "create" | "excel") => void;
  isDragging: Record<string, boolean>;
  handleDrag: (id: string, e: React.DragEvent) => void;
  handleBranchExcelUpload: (e: React.ChangeEvent<HTMLInputElement>) => void;
  handleBranchExcelDrop: (e: React.DragEvent) => void;
  addBranch: () => void;
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setNewBranch({ ...newBranch, taxCode: e.target.value })
                    }
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setNewBranch({ ...newBranch, taxAddress: e.target.value })
                    }
