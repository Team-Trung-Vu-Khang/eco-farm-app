...
interface RegionLivestockInfoStepProps {
  showCenterPoint?: boolean;
}

export const RegionLivestockInfoStep = ({
  showCenterPoint = false,
}: RegionLivestockInfoStepProps = {}) => {
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
          ...
          {/* <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>
                  Vật nuôi chính <span className="text-red-500">*</span>
                </FormLabel>
                <FormControl>
                  <MultiSelect
                    options={cropOptions}
                    ...
                    searchPlaceholder="Tìm kiếm vật nuôi..."
                    emptyText="Không tìm thấy vật nuôi"
                  />
                </FormControl>
                <FormMessage />
              </FormItem>
