...
import { useRegionBasicLivestockDetailPage } from "./hooks/useRegionBasicLivestockDetailPage";

const RegionBasicDistributionLivestockDetailPage = () => {
  const {
    setLocation,
    region,
    isLoading,
    ...
    landTypeName,
    terrainName,
  } = useRegionBasicLivestockDetailPage();
      ...
      <AdminLayout isDev={true} title="Đang tải...">
        <div className="flex flex-col items-center justify-center p-12">
          ...
          <p className="mt-4 text-muted-foreground">
            Đang tải thông tin vùng chăn nuôi...
          </p>
        </div>
      </AdminLayout>
    );
    ...
    return (
      <AdminLayout isDev={true} title="Không tìm thấy">
        <div className="flex flex-col items-center justify-center p-8">
          <p className="mb-4 text-xl">Vùng chăn nuôi không tồn tại</p>
          <Button onClick={() => setLocation("/cultivation-region-identification/animal")}>
            Quay lại danh sách
          </Button>
        </div>
      </AdminLayout>
    ...
    <AdminLayout
      ...
      actions={
        <div className="flex gap-2">
          <Button
            variant="outline"
            onClick={() => setLocation("/cultivation-region-identification/animal")}
          >
            <ChevronLeft className="mr-2 h-4 w-4" />
            Quay lại
          </Button>
          <Button onClick={() => setLocation(`/cultivation-region-identification/animal/edit/${region.id}`)}>
...
export default RegionBasicDistributionLivestockDetailPage;
