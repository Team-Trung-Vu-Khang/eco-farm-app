...
export const MOCK_REGIONS: Region[] = [
  ...
  },
  {
    id: 10,
    code: "REG-DL-10",
    name: "Vùng Cao Nguyên Di Linh",
    provinceId: "lam-dong",
    districtId: "di-linh",
    address: "Huyện Di Linh, Lâm Đồng",
    enterpriseId: "1",
    area: 120.0,
    landType: "DAT002",
    terrain: "DH003",
    note: "Vùng núi cao, khí hậu mát mẻ chuyên canh cà phê và sầu riêng.",
    status: "active",
  ...
  },
  {
    id: 11,
    code: "REG-CD-11",
    name: "Vùng Chè & Cà Phê Cầu Đất",
    provinceId: "lam-dong",
    districtId: "da-lat",
    address: "Xã Xuân Trường, TP. Đà Lạt",
    enterpriseId: "1",
    area: 85.5,
    landType: "DAT002",
    terrain: "DH003",
    note: "Vùng núi cực cao, mây phủ quanh năm, chuyên các loại Arabica đặc sản.",
    status: "active",
