...
import { useRegionBasicDetailPage } from "./hooks/useRegionBasicDetailPage";

const RegionBasicDistributionDetailPage = () => {
  const {
    setLocation,
    region,
    isLoading,
      ...
      actions={
        <div className="flex gap-2">
          ...
          <Button
            onClick={() =>
              setLocation(
                `/cultivation-region-identification/crop/edit/${region.id}`,
              )
            }
          >
...
export default RegionBasicDistributionDetailPage;
