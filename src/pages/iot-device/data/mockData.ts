...
export const mockDevices: IoTDevice[] = [
  {
    ...
    perceptionLayerId: "air_temp_humidity_sensor",
    networkLayerId: "lorawan",
  ...
  },
  {
    ...
    perceptionLayerId: "ph_temp_sensor",
    networkLayerId: "4g_nbiot",
    firmwareVersion: "v2.1.0",
    manufacturer: "GreenTech IoT",
    status: "online",
    batteryLevel: 92,
  ...
  },
  {
    ...
    perceptionLayerId: "ai_camera",
    networkLayerId: "transmission_protocols",
