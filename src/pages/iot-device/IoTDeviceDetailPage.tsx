...
export default function IoTDeviceDetailPage() {
  ...
  const handleDisconnect = () => {
    ...
    toast({
      ...
      description:
        "Thiết bị đã được chuyển sang trạng thái Offline. Hệ thống sẽ ngừng nhận dữ liệu Telemetry.",
      variant: "destructive",
    });
  };
          ...
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription className="text-center">
                Bạn có chắc chắn muốn ngắt kết nối thiết bị này? Hệ thống sẽ
                ngừng nhận dữ liệu Telemetry từ thiết bị.
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
                ...
                <Card className="border-none shadow-sm ring-1 ring-slate-200/50">
                  ...
                  <CardContent className="space-y-3">
                    <Button
                      ...
                      variant="outline"
                      onClick={() => handleCommand("Kích hoạt thủ công")}
                    >
                      Kích hoạt thủ công
                    ...
                    <Button
                      className="w-full justify-between"
                      variant="outline"
                      onClick={() => handleCommand("Hiệu chuẩn cảm biến")}
                    >
                      Hiệu chuẩn cảm biến
                    ...
                    <Button
                      className="w-full justify-between"
                      variant="outline"
                      onClick={() => handleCommand("Cập nhật Firmware")}
                    >
                      Cập nhật Firmware
                  ...
                  {[
                    {
                      time: "10:45 AM",
                      type: "Command",
                      desc: "Lệnh Kích hoạt thủ công đã thực thi",
                      status: "success",
                    },
                    {
                      time: "09:30 AM",
                      type: "Alert",
                      desc: "Cảnh báo pin yếu (15%)",
                      status: "warning",
                    },
                    {
                      time: "Hôm qua",
                      type: "Update",
                      desc: "Đã cập nhật lên Firmware v2.1.0",
                      status: "info",
                    },
                    {
                      time: "02/05/2024",
                      type: "Heartbeat",
                      desc: "Mất kết nối Heartbeat trong 5 phút",
                      status: "error",
                    },
                  ].map((event, idx) => (
                    <div
