      ...
      <div className="p-4">
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center justify-between mb-1">
              <Badge
                variant="outline"
                className="text-[10px] uppercase font-bold tracking-wider py-0 px-2 h-5 border-emerald-200 text-emerald-700 bg-emerald-50"
              >
                {primaryType}
              </Badge>
              <div className="flex items-center gap-1">
                <Button
                  ...
                  variant="ghost"
                  size="sm"
                  className="h-7 px-2.5 text-xs text-emerald-600 font-bold hover:bg-emerald-50 rounded-lg"
        ...
        <div className="mt-4 pt-3 border-t border-slate-100">
          <button
            ...
            className="flex items-center gap-1.5 text-[10px] font-bold uppercase tracking-widest text-slate-400 hover:text-emerald-600 transition-colors mb-2"
          >
            {isExpanded ? (
