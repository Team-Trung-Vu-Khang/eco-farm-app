...
export const MOCK_TASKS: FarmTaskResponse[] = [
  {
    ...
    personnel: [{ id: 3, fullName: "Lê Văn Cường", role: "EXECUTOR" }],
    startDate: "2026-09-05",
    endDate: "2026-09-10",
    durationDays: 5,
  ...
  },
  {
    ...
    personnel: [{ id: 5, fullName: "Hoàng Văn Em", role: "EXECUTOR" }],
    startDate: "2026-09-02",
    endDate: "2026-09-06",
    durationDays: 4,
    spawnedChildCount: null,
  ...
  },
  {
    ...
    personnel: [
      { id: 3, fullName: "Lê Văn Cường", role: "EXECUTOR" },
      { id: 4, fullName: "Phạm Thị Dung", role: "QUALITY_INSPECTOR" },
    ],
    startDate: "2024-03-10",
    endDate: "2024-03-15",
    durationDays: 5,
  ...
  },
  {
    ...
    personnel: [
      { id: 7, fullName: "Đặng Văn Giang", role: "EXECUTOR" },
      { id: 8, fullName: "Bùi Thị Hạnh", role: "EXECUTOR" },
      { id: 3, fullName: "Lê Văn Cường", role: "QUALITY_INSPECTOR" },
    ],
    startDate: "2024-08-20",
    endDate: "2024-08-25",
    durationDays: 5,
  ...
  },
  {
    ...
    personnel: [
      { id: 9, fullName: "Đỗ Văn Hùng", role: "EXECUTOR" },
      { id: 11, fullName: "Ngô Văn Minh", role: "QUALITY_INSPECTOR" },
    ],
    startDate: "2025-01-10",
    endDate: "2025-01-12",
    durationDays: 2,
  ...
  },
  {
    ...
    personnel: [{ id: 15, fullName: "Nguyễn Văn Sơn", role: "EXECUTOR" }],
  ...
  },
  {
    ...
    personnel: [
      { id: 6, fullName: "Vũ Thị Phương", role: "EXECUTOR" },
      { id: 4, fullName: "Phạm Thị Dung", role: "QUALITY_INSPECTOR" },
    ],
  ...
  },
  {
    ...
    note: null,
    personnel: [
      { id: 13, fullName: "Lý Văn Phúc", role: "EXECUTOR" },
      { id: 14, fullName: "Mai Thị Quyên", role: "EXECUTOR" },
    ],
