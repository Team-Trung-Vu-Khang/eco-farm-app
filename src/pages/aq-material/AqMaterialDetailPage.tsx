...
import { mockMaterialSuppliers } from "../material/data/constants";
                ...
                {mockMaterialSuppliers.map((sup, idx) => (
                  ...
                  >
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <h5 className="font-semibold text-sm text-slate-900">{sup.name}</h5>
                        <div className="flex items-center gap-2 mt-1 text-xs text-muted-foreground">
                          <span className="bg-slate-100 px-1.5 py-0.5 rounded">Đơn vị</span>
                        </div>
                      </div>
                    </div>
                    <div className="text-right">
                      <div className="text-sm font-medium">{sup.quantity} {sup.unit}</div>
                      <div className="text-xs text-muted-foreground">{sup.packaging}</div>
                    </div>
                  </div>
                ))}
              </CardContent>
          ...
          <Card>
            ...
            <CardContent className="pt-4">
              <div className="flex flex-wrap gap-2">
                ...
                <Badge variant="secondary" className="font-normal">#BenBi</Badge>
                <Badge variant="secondary" className="font-normal">#ChatLuongCao</Badge>
              </div>
            </CardContent>
          </Card>
