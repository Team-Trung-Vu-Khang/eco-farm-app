...
export default function PlanAquacultureGrowthWorkflowInfoFormPage() {
  ...
  return (
    <PageWrapper
      ...
      description="Tên, mô tả và vùng nuôi trồng thủy sản áp dụng cho quy trình này"
      actions={
              ...
              <div className="space-y-2">
                ...
                {regionsTouched && selections.length === 0 && (
                  <p className="text-xs text-destructive">
                    Vui lòng chọn ít nhất một vùng nuôi trồng thủy sản
                  </p>
                )}
