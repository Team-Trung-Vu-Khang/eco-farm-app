...
interface PlanAquacultureGrowthDetailPageProps {
  basePath?: string;
}

export default function PlanAquacultureGrowthDetailPage({
  basePath = "/plan-aquaculture-growth",
}: PlanAquacultureGrowthDetailPageProps) {
  const {
    plan,
    loading,
    growthCycles,
    ...
    handleConfirmDelete,
    goBack,
  } = useAquacultureGrowthDetailPage(basePath);
  ...
  return (
    ...
    >
      <div className="space-y-6">
        ...
        {/* Quy trình nuôi trồng thủy sản (Stages) */}
