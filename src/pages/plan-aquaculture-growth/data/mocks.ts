export const LOCATIONS = [
  ...
  {
    id: "pr-2",
    name: "Vùng nuôi trồng thủy sản Tôm sú - Bình Phước",
    crop: "Tôm thẻ",
    variety: "Duroc",
    zones: [
      {
  ...
  {
    id: "pr-3",
    name: "Vùng nuôi trồng thủy sản Cá tra - Đồng Nai",
    crop: "Cá tra",
    variety: "Cá tra",
    zones: [
      {
...
export const MATERIAL_TYPES = [
  ...
  { value: "Thuốc thủy sản", label: "Thuốc thủy sản" },
...
> = {
  ...
  "Thuốc thủy sản": [
    ...
    { value: "Thuoc sat trung", label: "Thuốc sát trùng ao nuôi", unit: "lít" },
    { value: "Dien giai", label: "Điện giải - vitamin tổng hợp", unit: "gói" },
    {
      value: "Khang sinh phac do",
      label: "Kháng sinh theo phác đồ thủy sản",
      unit: "chai",
    },
    ...
    { value: "Thuoc ha sot", label: "Thuốc hạ sốt thủy sản", unit: "chai" },
  ],
  Giống: [
    ...
    { value: "Cá tra", label: "Giống Cá tra", unit: "con" },
    { value: "Cá basa", label: "Giống Cá basa", unit: "con" },
  ...
  "Nông cụ": [
    ...
    { value: "May phun khu trung", label: "Máy phun khử trùng ao", unit: "cái" },
    { value: "Quat thong gio", label: "Quạt thông gió ao nuôi", unit: "cái" },
  ...
  "Vật tư khác": [
    ...
    { value: "Chat don chuong", label: "Vôi cải tạo ao", unit: "bao" },
    { value: "Voi sat trung", label: "Vôi sát trùng đáy ao", unit: "kg" },
...
export const MATERIAL_UNITS: Record<string, string[]> = {
  ...
  "Thuốc thủy sản": ["lít", "ml", "chai", "gói", "can", "phi", "liều"],
  Giống: ["con", "đàn", "lô"],
...
export const TASK_OPTIONS = [
  { value: "Vệ sinh xử lý ao nuôi", label: "Vệ sinh xử lý ao nuôi" },
  ...
  { value: "Bảo dưỡng hệ thống ao nuôi", label: "Bảo dưỡng hệ thống ao nuôi" },
];
