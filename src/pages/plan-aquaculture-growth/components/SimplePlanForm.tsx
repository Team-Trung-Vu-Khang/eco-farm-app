...
import type {
  AquacultureSupplyCatalog,
  AquacultureSupplyType,
...
import AquacultureGrowthCycleSelector from "./AquacultureGrowthCycleSelector";
import {
...
function StageMaterialPicker({
  ...
  const [newItem, setNewItem] = useState({
    ...
    searchValue: "",
    type: defaultType as AquacultureSupplyType,
  });
      ...
      <div className="grid grid-cols-12 gap-2">
        <div className="col-span-4">
          <Select
            value={newItem.type}
            onValueChange={(v) => {
              const type = v as AquacultureSupplyType;
    ...
    <div className="max-w-2xl mx-auto space-y-6 pb-24">
      ...
      <div className="space-y-2">
        <div className="flex items-center justify-between">
          <Label required={!isWorkflowContext}>Vùng nuôi trồng thủy sản</Label>
