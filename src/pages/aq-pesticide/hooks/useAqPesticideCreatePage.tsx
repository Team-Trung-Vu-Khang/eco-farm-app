...
export function useAqPesticideCreatePage() {
  ...
  const [match, params] = useRoute("/aquaculture-material/pesticide/:id/edit");
  ...
  useEffect(() => {
    ...
    Promise.all([
      ...
      farmSupplyApi.getTargetSubjects("AQUACULTURE"),
    ...
    try {
      ...
      const payload: any = {
        ...
        metadataJson: {
          ...
          usageMethod: formData.actionType || undefined,
        },
  ...
  const steps = [
    ...
    },
    {
      ...
      title: "Xác nhận",
      content: (
        <PesticideConfirmStep formData={formData} domain="aquaculture" />
      ),
    },
  ];
