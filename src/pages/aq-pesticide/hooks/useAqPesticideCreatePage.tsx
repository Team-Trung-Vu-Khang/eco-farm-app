...
export function useAqPesticideCreatePage() {
  ...
  const handleConfirmSubmit = async () => {
    ...
    if (isEdit && params?.id) {
      ...
      toast({ title: "Thành công", description: "Đã thêm mới thuốc thủy sản" });
    }
  ...
  const steps = [
    ...
    },
    {
      id: "confirm",
      title: "Xác nhận",
      content: <PesticideConfirmStep formData={formData} domain="aquaculture" />,
    },
  ];
