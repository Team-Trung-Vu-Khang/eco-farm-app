...
import {
  initialAnimalGrowthPlans,
  initialAnimalGrowthWorkflows,
} from "@/stores/animalGrowthWorkflowSeed";
import type { DiagramInfoRecord } from "../hooks/useAnimalGrowthWorkflowDraftStore";
import type {
