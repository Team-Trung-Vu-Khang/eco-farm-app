...
interface PlanAnimalGrowthDetailPageProps {
  basePath?: string;
}

export default function PlanAnimalGrowthDetailPage({
  basePath = "/plan-animal-growth",
}: PlanAnimalGrowthDetailPageProps) {
  const {
    plan,
    regions,
    growthCycles,
    ...
    handleConfirmDelete,
    goBack,
  } = useAnimalGrowthDetailPage(basePath);
