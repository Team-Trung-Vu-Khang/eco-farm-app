...
// Placeholder — useAnimalGrowthWorkflowDraftStore auto-lays out the whole tree after
...
interface AnimalGrowthWorkflowDraftState {
  nodes: DraftNode[];
  edges: Edge[];
...
export const useAnimalGrowthWorkflowDraftStore = create<AnimalGrowthWorkflowDraftState>()((set, get) => ({
  nodes: [],
  edges: [],
  infoNodes: [],
