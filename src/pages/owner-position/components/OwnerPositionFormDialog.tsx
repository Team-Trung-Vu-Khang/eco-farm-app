  ...
  return {
    ...
    positionGroupId:
      editItem.positionGroupId != null
        ? String(editItem.positionGroupId)
        : editItem.positionGroup?.id != null
          ? String(editItem.positionGroup.id)
          : "",
...
export function OwnerPositionFormDialog({
  open,
  onOpenChange,
  editItem,
  groupOptions,
  ...
  const positionDetailQuery = useFarmPositionById(editItem?.id ?? 0, {
