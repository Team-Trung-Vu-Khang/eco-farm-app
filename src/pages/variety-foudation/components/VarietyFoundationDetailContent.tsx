...
interface VarietyFoundationDetailContentProps {
  varietyFoundation: VarietyFoundation;
  isStandalone: boolean;
}

export function VarietyFoundationDetailContent({
  varietyFoundation,
  isStandalone,
}: VarietyFoundationDetailContentProps) {
  return (
        ...
        <div className="lg:col-span-4 space-y-6">
          <Card className="overflow-hidden border-none shadow-md ring-1 ring-slate-200">
            <div className="aspect-square relative group">
              {varietyFoundation.illustration ? (
                <img
                  src={
                    varietyFoundation.illustration instanceof File
                      ? URL.createObjectURL(varietyFoundation.illustration)
                      : varietyFoundation.illustration
                  }
                  className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105"
                  alt={varietyFoundation.varietyFoundationName}
                />
              ) : (
              ...
              <div className="absolute top-4 right-4">
                <Badge
                  className={
                    varietyFoundation.status === "active"
            ...
            <CardContent className="p-6 grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="space-y-1">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <p className="font-serif italic text-lg text-slate-700">
                      {varietyFoundation.scientificName || "N/A"}
                    </p>
                  </div>
                </div>
                <div className="space-y-1">
              ...
              <div className="space-y-2 pl-6 border-l border-slate-100">
                ...
                <p className="text-slate-600 leading-relaxed text-sm">
                  {varietyFoundation.description || "Chưa có mô tả chi tiết."}
                </p>
              </div>
            </CardContent>
          </Card>
                ...
                <div className="p-4 rounded-xl bg-amber-50/50 border border-amber-100 flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-lg font-bold text-slate-800">
                      {varietyFoundation.growthDuration || "---"}
                    </p>
                  </div>
                </div>
                <div className="p-4 rounded-xl bg-amber-50/50 border border-amber-100 flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-lg font-bold text-slate-800">
                      {varietyFoundation.averageYield || "---"}
                    </p>
                  </div>
                </div>
              </div>
