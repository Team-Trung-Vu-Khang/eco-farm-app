...
export default function TaskEditPage() {
  ...
  const getSelectionSummary = (selections?: GeographicalSelection[]) =>
    getGeographicalSelectionSummary(selections || [], regions);
  ...
  const selectionSummary = useMemo(
    ...
    [formData.geographicalSelections, regions],
  );
  ...
  const availableAssignees = buildTaskAssigneeOptions(
  ...
  const filteredRegionsForPhatSinh = filterRegionsBySelections(
    regions,
    formData.geographicalSelections,
    formData.objectiveType === "phat-sinh",
  );
  ...
  return (
    ...
    >
      ...
      <TaskPersonnelPickerDialog
        ...
        description={`Danh sách ${formData.assignedType === "team" ? "đội nhóm" : "nhân sự kỹ thuật"}`}
        searchPlaceholder="Tìm nhanh theo tên hoặc mã..."
        searchValue={searchAssignee}
        onSearchChange={setSearchAssignee}
        ...
        icon={Users}
        teamMode={formData.assignedType === "team"}
        large
      />
    </AdminLayout>
  );
