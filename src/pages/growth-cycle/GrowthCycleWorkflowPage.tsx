...
function getWorkflowStorageKey(cycleId: string | number) {
  return `growth-cycle-workflow-layout:${WORKFLOW_LAYOUT_VERSION}:${cycleId}`;
}
...
export default function GrowthCycleWorkflowPage() {
        ...
        data: {
          ...
          actions: [
            ...
            },
            {
              label: "Chỉnh sửa",
              icon: PencilLine,
              onClick: () => setLocation(`/growth-cycle/${cycle.id}/edit`),
            },
            {
              label: "Thêm node",
              icon: Plus,
    ...
    <AdminLayout
      ...
      actions={
        <div className="flex flex-wrap gap-2">
          ...
          <Link href={`/growth-cycle/${currentCycle.id}/edit`}>
              ...
              <div className="space-y-4">
                <div className="relative">
                  ...
                  <Input
                    ...
                    placeholder="Tìm theo mã, tên, mùa vụ, cây trồng..."
