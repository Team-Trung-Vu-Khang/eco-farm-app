...
export interface GrowthCycleHierarchyPrimaryOption {
  id: string;
  name: string;
  group: string;
  image: string;
...
export interface GrowthCycleHierarchyChildOption {
  id: string;
  primaryId: string;
  name: string;
  group: string;
...
interface GrowthCycleHierarchyDialogProps {
  open: boolean;
  ...
  primaryOptions: GrowthCycleHierarchyPrimaryOption[];
  childOptions: GrowthCycleHierarchyChildOption[];
  primaryLabel: string;
  childLabel: string;
  showChildSection: boolean;
  onConfirm: (payload: {
    primary: GrowthCycleHierarchyPrimaryOption;
    child?: GrowthCycleHierarchyChildOption;
  }) => void;
}
...
function OptionCard({
  ...
  option: GrowthCycleHierarchyPrimaryOption | GrowthCycleHierarchyChildOption;
  selected: boolean;
  onClick: () => void;
}) {
  return (
...
export function GrowthCycleHierarchyDialog({
  open,
  onOpenChange,
  title,
  description,
  ...
  showChildSection,
  onConfirm,
}: GrowthCycleHierarchyDialogProps) {
