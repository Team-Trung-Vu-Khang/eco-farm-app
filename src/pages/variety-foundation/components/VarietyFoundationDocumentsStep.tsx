import { BookOpen, FileText, Trash, Upload } from "lucide-react";
import {
  Button,
  Card,
  Editor,
        ...
        <div className="relative z-10 flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-purple-700/80">
              Lưu trữ các hướng dẫn kỹ thuật quan trọng cho giống cây (nền tảng)
              này
            </p>
          </div>
        </div>
                    ...
                    <div className="flex flex-col items-center gap-6 text-center z-10 p-8">
                      ...
                      <div className="space-y-2">
                        ...
                        <p className="text-sm text-slate-500 max-w-xs mx-auto">
                          Kéo thả file vào đây hoặc click để chọn từ máy tính
                          của bạn
                        </p>
                      </div>
                    </div>
