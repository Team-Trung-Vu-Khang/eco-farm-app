...
export function createAquacultureGrowthCycleColumns({ onView, onEdit, onDelete }: AquacultureGrowthCycleColumnActions): Column<GrowthCycle>[] {
  return [
    ...
    { key: "name", label: "Chu kỳ", render: (value) => <div className="flex items-center gap-2"><Sprout className="h-4 w-4 text-primary" /><span className="font-semibold">{value}</span></div> },
