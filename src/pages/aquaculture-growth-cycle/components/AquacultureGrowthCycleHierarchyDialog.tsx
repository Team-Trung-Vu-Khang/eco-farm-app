...
export interface AquacultureGrowthCycleHierarchyPrimaryOption {
  id: string;
  name: string;
  group: string;
  image: string;
...
export interface AquacultureGrowthCycleHierarchyChildOption {
  id: string;
  primaryId: string;
  name: string;
  group: string;
...
interface AquacultureGrowthCycleHierarchyDialogProps {
  open: boolean;
  ...
  primaryOptions: AquacultureGrowthCycleHierarchyPrimaryOption[];
  childOptions: AquacultureGrowthCycleHierarchyChildOption[];
  primaryLabel: string;
  childLabel: string;
  showChildSection: boolean;
  onConfirm: (payload: {
    primary: AquacultureGrowthCycleHierarchyPrimaryOption;
    child?: AquacultureGrowthCycleHierarchyChildOption;
  }) => void;
}
...
export function AquacultureGrowthCycleHierarchyDialog({
  open,
  onOpenChange,
  title,
  description,
  ...
  showChildSection,
  onConfirm,
}: AquacultureGrowthCycleHierarchyDialogProps) {
