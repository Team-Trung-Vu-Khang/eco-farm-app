...
const BiologicalProductCreatePage = () => {
  const {
    ...
    submitting,
    scope,
  } = useBiologicalProductCreateForm();
  ...
  const steps = [
    {
      ...
      content: (
        <BiologicalProductBasicInfoStep
          formData={formData}
    ...
    },
    {
      ...
      content: (
        <BiologicalProductSafetyLegalStep
          formData={formData}
          updateField={updateField}
        />
      ),
    },
    {
      ...
      content: (
        <BiologicalProductSuppliersStep
          formData={formData}
          updateField={updateField}
        />
      ),
    },
    {
      id: "confirm",
      title: "Xác nhận",
      content: <BiologicalProductConfirmationStep formData={formData} />,
    },
  ];
          ...
          <AlertDialogHeader>
            ...
            <AlertDialogDescription className="space-y-3" asChild>
              <div>
                <p>
                  {isEdit
                    ? "Bạn có chắc chắn muốn cập nhật thông tin chế phẩm sinh học này?"
                    : "Bạn có chắc chắn muốn thêm chế phẩm sinh học mới vào hệ thống?"}
                </p>
...
export default BiologicalProductCreatePage;
