...
interface BiologicalProductSafetyLegalStepProps {
...
export default function BiologicalProductSafetyLegalStep({
  formData,
  updateField,
}: BiologicalProductSafetyLegalStepProps) {
      ...
      <div className="bg-white p-6 rounded-xl shadow-sm border space-y-5">
        ...
        <div className="space-y-3">
          ...
          <p className="text-xs text-muted-foreground -mt-1">
            Chọn các chứng nhận/tiêu chuẩn quy trình sản xuất chế phẩm sinh học đạt được
          </p>
          <MultiSelect
