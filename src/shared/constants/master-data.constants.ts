...
export const MASTER_DATA_PATHS = {
  ...
  biologicalProductGroups: `${MASTER_DATA_BASE_PATH}/biological-product-groups`,
  byProductGroups: `${MASTER_DATA_BASE_PATH}/by-product-groups`,
  ...
  pesticideGroups: `${MASTER_DATA_BASE_PATH}/medicine-groups`,
  pesticideOrigins: `${MASTER_DATA_BASE_PATH}/medicine-groups`,
  pesticideToxicityClasses: `${MASTER_DATA_BASE_PATH}/medicine-groups`,
